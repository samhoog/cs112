...
void ListTester::testInsertBefore() {
	...
	assert( list2.getFirst() == "4" );
	assert( list2.myFirst->myNext->myItem == "4.5" );
	assert( list2.myFirst->myNext->myNext->myItem == "5" );
	assert( list2.getLast() == "6" );
	cout << " 2 " << flush;
